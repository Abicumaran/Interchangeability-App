...
- The study-level global_flag exclusion is applied before reportable analysis and retained in its dedicated audit sheet.
...
- The only downloadable results file is one Excel workbook with: `Trueness Results`, `Bland-Altman Results`, `Outliers`, `global flag TRUE`.
